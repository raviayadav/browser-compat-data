...
- 5 contributors have changed 44 files with 627 additions and 292 deletions in 14 commits ([`v8.1.1...v8.1.2`](https://github.com/mdn/browser-compat-data/compare/v8.1.1...v8.1.2))
- 20,526 total features
- 1,270 total contributors
- 5,749 total stargazers
